...
# the repository URL identifies the authors: anonymize for review
body = body.replace(
    r"\url{https://github.com/clarimar/tep-onset-benchmark} and archived under" "\n"
    r"\TBD{Zenodo concept DOI}",
    r"\TBD{anonymized repository for peer review}; the non-anonymized" "\n"
    r"repository and its archival DOI are cited in the accepted version")
